...
TOOLS = [
    ...
    {"href": "Meta_Analysis", "icon": "🔬", "title": "Meta-Analysis",
     "desc": "Pairwise, diagnostic (DTA/SROC) & network meta-analysis → forests, funnel, league table, rankings.",
     "pills": ["PAIRWISE + DTA + NMA", "FOREST + SROC", "R SCRIPT"], "tint": "#fdeede", "fg": "#d8572a"},
    ...
    {"href": "Fuzzy_Title_Match", "icon": "🔭", "title": "Fuzzy Match",
     "desc": "Match any column by similarity (titles, authors, journals, DOIs…) — reconcile two lists or find duplicates.",
     "pills": ["MATCH ON ANY COLUMN"], "tint": "#fce8ef", "fg": "#c0398b"},
